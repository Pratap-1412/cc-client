...
export default function Userlist() {
    ...
    const getData = async () => {
        let result = await fetch("https://codingclubrrsimtservertrue.onrender.com/userslist");
        result = await result.json();
        setUser(result);

    };
    const deleteProduct = async (id) => {
        let result = await fetch(`https://codingclubrrsimtservertrue.onrender.com/userslist/${id}`, {
            method: "Delete"
        });
        result = await result.json();
        if (result) {
